...
var CheckBox = React.createClass({
  ...
  render() {
    var iconName = (this.props.dots === true) ? 'fontawesome|square-o' : 'fontawesome|ellipsis-h'
    console.log(iconName)

    // var source = this.props.dots === true ? require('image!cb-disabled') : require('image!cb-dots')
